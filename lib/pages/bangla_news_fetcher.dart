...
class BanglaNewsFetcher extends StatefulWidget {
  final String url;

  const BanglaNewsFetcher({super.key, required this.url});

  @override
  State<BanglaNewsFetcher> createState() => _BanglaNewsFetcherState();
}

class _BanglaNewsFetcherState extends State<BanglaNewsFetcher> {
  List<String> headlines = [], links = [], imageUrls = [], timestamps = [];
      ...
      body: Stack(
        children: [
          ...
          Container(
            ...
            child: Center(
              child: Padding(
                padding: EdgeInsets.only(bottom: AppBar().preferredSize.height + MediaQuery.of(context).padding.bottom),
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [SizedBox(
                        ...
                        Text("fetching news data...", style: TextStyle(color: Colors.white),)
                      ],
                    )
                  ],
                ),
          ...
          //             21.0 + MediaQuery.of(context).padding.bottom),
          ...
          //                     children: [
          //                       Tooltip( // Show URL on hover/long-press
          ...
          //                         ),
          //                       ),
          //                       Text(headlines[index],style: TextStyle(color: Colors.white),),
          //                       Text(timestamps[index],style: TextStyle(color: Colors.white),),
          //                       Text(links[index],style: TextStyle(color: Colors.white),),
          //                     ],
          //                   )
          //               )
          //           )
